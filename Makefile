...
objects: wrf_atmosphere_mod.o module_fr_fire_util.o module_fr_fire_phys.o module_fr_fire_core.o \
  ...
  # Executable(s)
fire_behavior.exe: fire_behavior.o wrf_atmosphere_mod.o wrf_fire_test1_mod.o wrf_fire_test2_mod.o wrf_fire_test3_mod.o \
...
fire_behavior.o: fire_behavior.F wrf_atmosphere_mod.o wrf_fire_test1_mod.o wrf_fire_test2_mod.o wrf_fire_test3_mod.o \
	module_fr_fire_driver.o	module_fr_fire_driver_wrf.o  module_fr_fire_util.o \
	module_fr_fire_atm.o module_fr_fire_model.o module_fr_fire_core.o module_fr_fire_phys.o
...
wrf_fire_test3_mod.o: wrf_fire_test3_mod.F wrf_atmosphere_mod.o module_fr_fire_util.o
	$(CPP) $(CPPFLAGS) $< > wrf_fire_test3_mod.f90
	$(FC) $(FCFLAGS) -c wrf_fire_test3_mod.f90
