...
set size 1,1
#
set ylabel "Lats" font 'Times-Roman,25'
set yrange [39.67:39.6915]
set ytic autofreq font 'Times-Roman,25'
#set grid y
#
set xlabel 'Lons' font 'Times-Roman,25'
...
set style line 3 lt 3 lw 1 pt 7 ps 0.20
set style line 2 lt -1 lw 1 pt 5 ps 0.25
set style line 4 lt 5 lw 1 pt 7 ps 0.1
#set logscale y
#set logscale x
#plot '$1' u (\$2) notitle w linespoints linestyle 1
plot '$1' u (\$1):(\$2) title 'WRF-Fire centers' w points linestyle 1, '$2' u (\$1):(\$2) title 'Fire_behavior centers' w points linestyle 3, '$3' u (\$1):(\$2) title 'WRF atmosphere centers' w points linestyle 2, './test3/file.xyz' u (\$2):(\$1) title 'WRF-Fire centers (wrfout)' w points linestyle 4
